...
{
    public const string KernelLogName = "SoruxBot.Kernel";
    ...
    public const string KernelPluginServiceLocalStorageLogName = "SoruxBot.Kernel.PluginService.LocalStorage";
}